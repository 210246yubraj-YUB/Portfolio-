...
const experience = [
  {
    ...
    period: "2026–Present",
    description:
      "Teaching robotics, electronics, and programming. Conducting hands-on workshops and guiding student projects.",
  },
  {
    title: "R&D Intern",
    ...
    period: "2023–2024",
    description:
      "Arduino-based system development, circuit design (Proteus, EasyEDA), and sensor integration/debugging.",
  },
  {
    ...
    period: "2023–2026",
    description:
      "Managed multiple leadership and creative responsibilities. Provided strategic guidance as an Advisor, oversaw campus operations as Deputy Campus Director, and led visual branding as a Graphics Designer.",
  },
];
...
const projects = [
  {
    ...
    description:
      "Accident detection with GSM alert and GPS tracking system integrated into a motorcycle helmet.",
    tech: ["ESP32", "GSM", "GPS", "Sensors"],
    image:
      "https://i.postimg.cc/vZtZKm0n/Whats-App-Image-2026-02-15-at-13-36-52.jpg",
  },
  {
    title: "Robotic Prosthetic Arm",
    category: "Embedded Control",
    description:
      "Sensor-controlled robotic arm using servo motors and advanced embedded control logic.",
    tech: ["Arduino", "Servo Motors", "EMG/Flex Sensors"],
    image:
      "https://i.postimg.cc/X7hfvsW-w/Whats-App-Image-2024-09-03-at-19-41-15.jpg",
  },
  {
    title: "Automatic Plant Watering System",
    category: "Home Automation",
    description:
      "Soil moisture automation system with LCD display and mobile monitoring via IoT protocols.",
    tech: ["NodeMCU", "Soil Sensors", "Blynk App"],
    image:
      "https://i.postimg.cc/g222fWQg/baa0791b59bc18ff8084d45dbf8509d38368caaf.jpg",
  },
];
...
const services = [
  {
    ...
    description:
      "Comprehensive hands-on training for students and enthusiasts in robotics and automation.",
  },
  {
    title: "Student Project Development",
    icon: <Zap className="w-8 h-8" />,
    description:
      "End-to-end guidance and development support for engineering and academic projects.",
  },
  {
    title: "PCB Design",
    icon: <Server className="w-8 h-8" />,
    description:
      "Professional circuit design and PCB layout services using industry-standard tools.",
  },
  {
    title: "IoT System Development",
    icon: <Globe className="w-8 h-8" />,
    description:
      "Building custom IoT solutions with cloud integration and mobile monitoring.",
  },
];
...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10 w-full">
          ...
          >
            ...
            >
              Electronics & Communication Engineer. Building smart systems with{" "}
              <span className="text-white font-medium">IoT</span>,{" "}
              <span className="text-white font-medium">Embedded Tech</span> &{" "}
              <span className="text-white font-medium">Cloud Integration</span>.
            </motion.p>
            <motion.div
            ...
            >
              <a
                href="#projects"
                className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl flex items-center gap-2 group transition-all"
              >
                View Projects
            ...
            <div className="relative z-10 w-full max-w-[500px] mx-auto">
              <div className="aspect-[4/5] rounded-[2rem] overflow-hidden border-2 border-white/10 card-blur relative group shadow-[0_0_50px_-12px_rgba(37,99,235,0.3)]">
                ...
                >
                  ...
                  <div className="text-[10px] font-bold text-emerald-100 uppercase tracking-widest">
                    Architect
                  </div>
                  <div className="text-sm font-bold text-white">
                    Cloud & Networking
      ...
      <section
        id="about"
        className="py-24 px-6 relative overflow-hidden bg-white/[0.01]"
      >
          ...
          >
            <div className="md:w-1/2">
              ...
              <h2 className="text-4xl font-bold mb-8">
                Engineering a <span className="text-gradient">Smarter</span>{" "}
                Future
              </h2>
              <div className="space-y-6 text-gray-400 leading-relaxed text-lg">
                <p>
                  I am a passionate Electronics and Communication Engineering
                  graduate based in Kathmandu, Nepal. My core expertise lies at
                  the intersection of IoT systems, embedded development, and
                  networking fundamentals.
                </p>
                <p>
                  With hands-on experience in building real-world solutions like
                  smart safety systems and robotics, I bridge the gap between
                  physical hardware and digital intelligence. Currently, I'm
                  channeling my curiosity into Cloud Computing, Cybersecurity,
                  and Data engineering to build more secure and scalable
                  infrastructures.
                </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold">
              Tech <span className="text-gradient">Stack</span> & Focus
            </h2>
          </div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {items.map((item) => (
                    <span
                      key={item}
                      className="px-3 py-1 rounded-lg bg-white/5 border border-white/5 text-sm text-gray-300 hover:bg-white/10 transition-colors"
                    >
                      {item}
                    </span>
                  ))}
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  {idx !== experience.length - 1 && (
                    <div className="w-[2px] h-full bg-gradient-to-b from-blue-500/30 to-transparent mt-4" />
                  )}
                </div>
                <div className="pb-12">
                  <div className="text-sm font-mono text-emerald-400 mb-2 uppercase tracking-tighter">
                    {exp.period}
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-6">
            ...
            <a
              ...
              className="flex items-center gap-2 text-sm text-gray-400 hover:text-white transition-colors group underline decoration-blue-500/30 underline-offset-4"
            >
              View All on GitHub{" "}
                ...
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto flex flex-wrap gap-2">
                    {project.tech.map((t) => (
                      <span
                        key={t}
                        className="text-[10px] font-bold px-2 py-1 bg-white/5 border border-white/5 rounded-md text-gray-400 uppercase tracking-tighter"
                      >
                        {t}
                      </span>
                    ))}
          ...
          <motion.div {...fadeIn} transition={{ delay: 0.2 }}>
            ...
            <div className="grid gap-4">
              {certifications.map((cert, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-all cursor-default"
                >
      ...
      <section className="py-24 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto px-12 py-16 bg-blue-600 rounded-[3rem] relative overflow-hidden group">
          ...
          <motion.div
            className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-12"
            {...fadeIn}
          >
            <div className="max-w-md">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Recognized{" "}
                <span className="text-blue-200 italic">Excellence</span>
              </h2>
              <div className="flex flex-col gap-4 text-blue-50 text-lg">
                <div className="flex items-center gap-3">
                  <ChevronRight className="w-5 h-5" /> Full Scholarship
                  (Engineering)
                </div>
                <div className="flex items-center gap-3">
                  <ChevronRight className="w-5 h-5" /> 1st Runner-Up EEPEX
                  Competition
                </div>
                <div className="flex items-center gap-3">
                  <ChevronRight className="w-5 h-5" /> Robust Project Execution
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-4">
              <a href="/Yubraj_Shahi_CV.pdf" download="Yubraj_Shahi_CV.pdf">
          ...
          <div className="grid md:grid-cols-2 gap-20">
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed mb-12">
                I'm currently seeking opportunities in networking,
                cybersecurity, and IoT engineering. Whether you have a question
                or just want to connect, my inbox is always open.
              </p>

              <div className="space-y-8">
                <a
                  href="mailto:yubrajshahi395@gmail.com"
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xl font-bold hover:text-blue-400 transition-colors">
                      yubrajshahi395@gmail.com
                    </div>
                  </div>
                </a>
                <a
                  href="https://wa.me/9779801799303"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block"
                >
                  <div className="flex items-center gap-6 group cursor-pointer">
                    ...
                    <div>
                      ...
                      <div className="text-xl font-bold hover:text-emerald-400 transition-colors">
                        +977 9801799303
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex gap-4 mt-12">
                {[
                  ...
                  },
                  {
                    ...
                    href: "https://github.com/210246yubraj-YUB",
                  },
                  {
                    icon: <Facebook className="w-5 h-5" />,
                    href: "https://www.facebook.com/roboshiksha",
                  },
                ].map((social, i) => (
                  <a
                    key={i}
                    href={social.href}
                    className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-blue-600 transition-colors"
                  >
                    {social.icon}
                  </a>
                ))}
            ...
            >
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-black rounded-xl hover:shadow-[0_0_20px_rgba(37,99,235,0.4)] transition-all"
                >
                  Send Message
                </button>
              </form>
      ...
      <footer className="py-12 px-6 border-t border-white/5 text-center">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500">
            <div className="w-2 h-2 rounded-full bg-emerald-500" /> Nepal,
            Kathmandu
          </div>
        </div>
      </footer>
